...
describe('WHERE clause generation', function () {
  ...
  describe('generator', function () {
    it('should build an equality predicate', function () {
      const condition = {field: '"field"', operator: '=', value: 'value', offset: 1, params: []};
    ...
    it('should interpolate nulls directly', function () {
      const condition = {field: '"field"', operator: '=', value: null, offset: 1, params: []};
      const result = where.generator(condition);
    ...
    it('should create IN clauses for array parameters', function () {
      const condition = {field: '"field"', operator: '=', value: ['value1', 'value2'], offset: 1, params: []};
      const result = where.generator(condition);
  ...
  describe('docGenerator', function () {
    it('should build deep traversals', function () {
      ...
      const condition = {rawField: 'field', operator: '=', value: [{one: 'two'}], offset: 1, params: []};
    ...
    it('should build an equality predicate using the JSON contains op', function () {
      const condition = {rawField: 'field', operator: '=', value: 'value', offset: 1, params: []};
    ...
    it('should cast booleans in non-equality predicates', function () {
      const condition = {rawField: 'field', operator: '<>', value: true, offset: 1, params: []};
    ...
    it('should cast numbers in non-equality predicates', function () {
      const condition = {rawField: 'field', operator: '<>', value: 123.45, offset: 1, params: []};
    ...
    it('should cast dates in non-equality predicates', function () {
      const date = new Date();
      const condition = {rawField: 'field', operator: '<>', value: date, offset: 1, params: []};
    ...
    it('should create IN clauses for array parameters', function () {
      const condition = {rawField: 'field', operator: '=', value: ['value1', 'value2'], offset: 1, params: []};
  ...
  describe('isPkSearch', function () {
    ...
    it('should accept simple document criteria', function () {
      assert.equal(where.isPkSearch({id: 1}, {document: true}), true);
    });
