...
var Query = function(sql, params, pgdb, table) {
  ...
  // TODO: These should be expanded to select first/last with criteria
  self.first = function() {
    return self._append(" ORDER BY %s LIMIT 1 ", this.table.pk);
  };


  // TODO: These should be expanded to select first/last with criteria
  self.last = function() {
   return self._append(" ORDER BY %s DESC LIMIT 1 ", this.table.pk);
  };
