...
exports.parseKey = function (key) {
  ...
  var field = util.format('"%s"', parts.shift());   // field should always be quoted
  var operation = {};
  ...
  if (parts.length > 1) {
    ...
    field = util.format('%s%s%s', field, jsonOp, jsonKey);
  }
...
exports.forTable = function(conditions, placeholderOffset) {
  ...
  _.each(conditions, function(value, key) {
    ...
    return _conditions.push(util.format('%s %s %s', condition.field, condition.operator, value));
  });
