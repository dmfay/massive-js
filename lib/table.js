 ...
 * @param {String} args.name - The table's name.
 * @param {String} args.pk - The table's primary key column.
 * @param {String} args.schema - The name of the schema owning the table.
 */
