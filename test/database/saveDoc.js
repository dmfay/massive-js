...
describe('saveDoc', function () {
  ...
  describe('(UUID config) with an existing table', function () {
    before(function* () {
    ...
    after(function* () {
      yield db.dropTable('docs_uuid', {cascade: true});
  ...
  describe('(UUID config) with an existing table in a schema', function () {
    before(function* () {
      yield db.createSchema('myschema');
    ...
    after(function* () {
      yield db.dropSchema('myschema', {cascade: true});
