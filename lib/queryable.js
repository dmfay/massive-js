...
const Query = require('./statement/query');
...
Queryable.prototype.count = function(conditions = {}, params = []) {
  ...
  const query = new Query(this, conditions, {columns: "COUNT(1)", order: null, single: true});
...
Queryable.prototype.countDoc = function (criteria = {}) {
  const query = new Query(this, criteria, {columns: "COUNT(1)", order: null, single: true, generator: 'docGenerator'});
...
Queryable.prototype.find = function(criteria = {}, options = {}) {
  ...
  return this.db.query(new Query(this, criteria, options));
};
...
Queryable.prototype.search = function(plan, options = {}) {
  ...
  const query = new Query(this, criteria, options);
...
Queryable.prototype.where = function(conditions, params = []) {
  ...
  const query = new Query(this, {conditions: conditions, params: params}, {});
